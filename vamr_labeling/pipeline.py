...
pipeline.py
-----------
Top-level orchestrator for the VA-MR zero-shot labeling pipeline.
...
This module ties together all sub-modules and produces the deliverables
that feed into AutoResearch (Mindful-BERT fine-tuning) and CFiCS
