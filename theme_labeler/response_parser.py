...
- Uses extract_json from shared.llm_client (breaks circular dependency)
- Accepts a name_to_id map parameter instead of importing a global constant
- _parse_single_run imported from this package's zero_shot_classifier
"""
...
from .zero_shot_classifier import _parse_single_run
