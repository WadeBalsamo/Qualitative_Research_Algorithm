...
class SetupWizard:
    ...
    def _step_11d_gnn(self):
        ...
        print("          topical): 07_gnn/discriminant_validity.txt.")
        ...
        print("          mapped per cell (07_gnn/transition_model.txt, confound_localization.txt).")
        print("       3. SUBTEXT COMMUNITIES + DYADIC ROUTINES, cue motifs, coupling factors")
        print("          (07_gnn/communities.txt, dyadic_routines.txt, emergent_motifs.txt).")
        ...
        if clf:
            ...
            print()
            print("    AUTHORITATIVE LABELS — recommended OFF until 07_gnn/validation.txt says")
