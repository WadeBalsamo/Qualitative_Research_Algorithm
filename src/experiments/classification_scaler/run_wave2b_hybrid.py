...
cs_ids,lab6,_=B._prepare_labeled(df,emb,GnnLayerConfig(vaamr_n_classes=6)); CONS=dict(zip([str(x) for x in cs_ids],lab6))
...
for C in (1.0,4.0):
    ...
    score(f'W2b_pooledgate_x_perrater_C{C}',preds)
